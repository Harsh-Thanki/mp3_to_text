...
audio_file_path = "Kwaai Public Meeting May 17th 2024.mp3"  # MP3 file path
...
output_file_path = "transcription tiny model.txt"  # Replace with your desired output file path
